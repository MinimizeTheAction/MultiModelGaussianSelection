 ...
 *----------------------------------------------------------------------------------------
 * Development:
 *		1) Make more informative priors. Could have some initialization function which,
 *				would really only work for this example and comparables ones, but set 
 *				some of the prior ranges based on the data, i.e. x_avg for sure.
 *		2) Look into my bullshit machine epsilon value
 *     
 *	
 *----------------------------------------------------------------------------------------
 */
